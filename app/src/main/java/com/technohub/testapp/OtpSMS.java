...
public class OtpSMS extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
    ...
    LinearLayout layoutInput, layoutVerify;
    @Override
    ...
    public void startSMSListener() {
        ...
        mTask.addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override public void onSuccess(Void aVoid) {
                ...
                Toast.makeText(OtpSMS.this, "SMS Retriever starts", Toast.LENGTH_LONG).show();
            }
        });
        mTask.addOnFailureListener(new OnFailureListener() {
            @Override public void onFailure(@NonNull Exception e) {
                Toast.makeText(OtpSMS.this, "Error", Toast.LENGTH_LONG).show();
            }
        });
    }
